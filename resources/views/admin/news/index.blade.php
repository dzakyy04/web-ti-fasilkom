                    ...
                    <div class="col-12 col-sm-6 col-md-4 mt-3 news-item">
                        <div class="card card-bordered">
                            ...
                            <div
                                ...
                                <dev>{{ \Carbon\Carbon::parse($newsItem->created_at)->translatedFormat('d F Y') }}
                                </dev>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end dropdown-menu-xs">
                                        <ul class="link-list-plain">
                                            <li><a href="{{ route('news.edit', $newsItem->slug) }}">Edit</a>
                                            </li>
                                            <li>
                                                <a href="#" class="delete-link">Hapus</a>
                                                <form class="delete-form"
                                                    action="{{ route('news.delete', $newsItem->slug) }}"
