        ...
        $(document).ready(function() {
            ...
            @if ($errors->any())
                @if (session('edit_gallery_id') && old('_method') == 'PUT')
                    ...
                    var informationId = "{{ session('edit_gallery_id') }}";
                    var url = "{{ route('information-galleries.find', ':id') }}".replace(':id', informationId);
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            $('#editForm').attr('action',
                                "{{ route('information-galleries.update', ':id') }}".replace(':id',
                                    informationId));
            ...
            $('.edit-button').click(function() {
                ...
                var url = "{{ route('information-galleries.find', ':id') }}".replace(':id', informationId);
                $.ajax({
                    url: "{{ route('information-galleries.session', ':id') }}".replace(':id',
                        informationId),
                    type: 'GET',
                    success: function() {
                        $.ajax({
                            ...
                            success: function(response) {
                                ...
                                $('#editModal').modal('show');
                                $('#editForm').attr('action',
                                    "{{ route('information-galleries.update', ':id') }}"
                                    .replace(':id',
                                        informationId));
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $('#deleteForm').attr('action',
                            "{{ route('information-galleries.delete', ':id') }}".replace(
                                ':id',
                                informationId));
...
@section('content')
        ...
        <div class="nk-block nk-block-lg">
            <div class="nk-block-between">
                <div class="nk-block-head-content">
                    <h3 class="nk-block-title page-title">Galeri Informasi</h3>
                </div>
                <div class="nk-block-head-content">
                    <span class="d-inline-block" tabindex="0" data-bs-toggle="tooltip"
                    title="Batas maksimum satu galeri informasi jurusan">
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalForm"
                    @if ($disabledAddButton) disabled @endif>
                        <em class="icon ni ni-plus me-1"></em>Tambah Galeri Informasi Jurusan</span>
                    </button>
                </span>
                </div>
            </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Tambah Galeri Informasi</h5>
                    <a href="#" class="close" data-bs-dismiss="modal" aria-label="Close">
                        <em class="icon ni ni-cross"></em>
                    </a>
                </div>
                <div class="modal-body">
                    <form action="{{ route('information-galleries.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
    ...
    <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="editModalLabel">Edit Galeri Informasi</h5>
    ...
    <div class="modal fade" id="deleteModal" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="deleteModalLabel">Hapus Galeri Informasi</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
    ...
    <div class="modal fade" id="showModal" tabindex="-1" aria-labelledby="showModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="showModalLabel">Detail Galeri Informasi</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
