        ...
        $(document).ready(function() {
            ...
            @if ($errors->any())
                @if (session('edit_gallery_id') && old('_method') == 'PUT')
                    ...
                    var sliderItemId = "{{ session('edit_gallery_id') }}";
                    var url = "{{ route('slider-galleries.find', ':id') }}".replace(':id', sliderItemId);
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            $('#editForm').attr('action',
                                "{{ route('slider-galleries.update', ':id') }}".replace(':id',
                                    sliderItemId));
            ...
            $('.edit-button').click(function() {
                ...
                var url = "{{ route('slider-galleries.find', ':id') }}".replace(':id', sliderItemId);
                $.ajax({
                    url: "{{ route('slider-galleries.session', ':id') }}".replace(':id',
                        sliderItemId),
                    type: 'GET',
                    success: function() {
                        $.ajax({
                            ...
                            success: function(response) {
                                ...
                                $('#editModal').modal('show');
                                $('#editForm').attr('action',
                                    "{{ route('slider-galleries.update', ':id') }}"
                                    .replace(':id',
                                        sliderItemId));
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $('#deleteForm').attr('action',
                            "{{ route('slider-galleries.delete', ':id') }}".replace(':id',
                                sliderItemId));
...
@section('content')
        ...
        <div class="nk-block nk-block-lg">
            <div class="nk-block-between">
                <div class="nk-block-head-content">
                    <h3 class="nk-block-title page-title">Galeri Slider</h3>
                </div>
                <div class="nk-block-head-content">
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalForm">
                        <em class="icon ni ni-plus me-1"></em>Tambah Galeri Slider</span>
                    </button>
                </div>
            </div>
            <div class="mt-3">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Tambah Galeri Slider</h5>
                    <a href="#" class="close" data-bs-dismiss="modal" aria-label="Close">
                        <em class="icon ni ni-cross"></em>
                    </a>
                </div>
                <div class="modal-body">
                    <form action="{{ route('slider-galleries.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
    ...
    <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="editModalLabel">Edit Galeri Slider</h5>
    ...
    <div class="modal fade" id="deleteModal" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="deleteModalLabel">Hapus Galeri Slider</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
    ...
    <div class="modal fade" id="showModal" tabindex="-1" aria-labelledby="showModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="showModalLabel">Detail Slider</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
